...
This document describes the `exit_plan_mode` tool for Claudex.
...
## How to use `exit_plan_mode` with Claudex

The Exit Plan Mode tool is part of Claudex's planning workflow. When you're in plan mode (typically after exploring a codebase and designing an implementation approach), you use this tool to:
