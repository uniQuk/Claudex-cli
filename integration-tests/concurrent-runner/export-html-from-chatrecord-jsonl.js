...
<head>
  ...
  <title>Claudex Chat Export</title>
...
<body>
  <div class="page-wrapper">
    <div class="header">
      <div class="header-left">
        ...
        <div class="logo">
          <div class="logo-text" data-text="CLAUDEX">
            <span class="logo-text-inner">CLAUDEX</span>
          </div>
        </div>
      </div>
      <div class="meta">
  ...
  <script>
    ...
    const { ChatViewer, PlatformProvider } = ClaudexCodeWebUI;
