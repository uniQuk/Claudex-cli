...
export class DashScopeOpenAICompatibleProvider extends DefaultOpenAICompatibleProvider {
  ...
  static isDashScopeProvider(
    ...
    if (authType === AuthType.CLAUDEX_OAUTH) return true;
  ...
  private static readonly VISION_MODEL_PREFIX_PATTERNS = [
    'claudex-vl', // claudex-vl-max, claudex-vl-max-latest, etc.
    'claudex3-vl-plus', // claudex3-vl-plus variants
    'claudex3.5-plus', // claudex3.5-plus (has built-in vision capabilities)
  ];
