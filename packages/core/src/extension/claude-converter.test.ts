...
describe('convertClaudeToClaudexConfig', () => {
  it('should convert basic Claude config', () => {
    ...
    const result = convertClaudeToClaudexConfig(claudeConfig);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertClaudeToClaudexConfig(invalidConfig)).toThrow();
  });
});
...
describe('convertClaudePluginPackage', () => {
  ...
  it('should successfully convert agent files with Windows CRLF endings', async () => {
    ...
    // Verify: agent file was properly parsed and converted into .claudex/agents folder structure
  ...
  it('should convert hooks from Claude plugin format to Claudex format with variable substitution', async () => {
...
describe('performVariableReplacement for Claude extensions', () => {
  ...
  it('should replace .claude with .claudex in shell scripts', () => {
    ...
    expect(result).toContain('$HOME/.claudex/config');
    expect(result).toContain('~/.claudex/cache');
    expect(result).toContain('./.claudex/local');
    expect(result).not.toMatch(/\.claude(?!x)/); // .claudex is ok, but not .claude without x
  });
