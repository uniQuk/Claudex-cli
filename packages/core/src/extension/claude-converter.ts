...
/**
 * Converter for Claude Code plugins to Claudex format.
 */
...
/**
 * Converts a Claude agent config to Claudex subagent format.
 * @param claudeAgent Claude agent configuration
 * @returns Converted agent config compatible with Claudex SubagentConfig
 */
