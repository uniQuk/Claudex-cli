 ...
 * - 'project': Stored in `.claudex/skills/` within the project directory
 * - 'user': Stored in `~/.claudex/skills/` in the user's home directory
 * - 'extension': Provided by an installed extension
 * - 'bundled': Built-in skills shipped with claudex
 */
