...
describe('SkillTool', () => {
  ...
  const mockSkills: SkillConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.claudex/skills/code-review/SKILL.md',
    ...
    },
    {
      ...
      level: 'user',
      filePath: '/home/user/.claudex/skills/testing/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.claudex/skills/new-skill/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.claudex/skills/test-skill/SKILL.md',
          body: 'Test content.',
        },
      ];
  ...
  describe('SkillToolInvocation', () => {
    ...
    it('should execute skill load successfully', async () => {
      ...
      expect(llmText).toContain(
        'Base directory for this skill: /project/.claudex/skills/code-review',
      );
  ...
  describe('modelOverride propagation', () => {
    it('should propagate model from skill config to ToolResult', async () => {
      ...
      expect(result.modelOverride).toBe('claudex-max');
    });
