...
describe('AgentTool', () => {
  ...
  const mockSubagents: SubagentConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.claudex/agents/file-search.md',
    },
    {
      name: 'code-review',
      ...
      level: 'user',
      filePath: '/home/user/.claudex/agents/code-review.md',
    },
  ];
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.claudex/agents/new-agent.md',
        },
      ];
      ...
      const newSubagents: SubagentConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.claudex/agents/test-agent.md',
        },
      ];
  ...
  describe('Agent-level background: true', () => {
    ...
    const bgSubagent: SubagentConfig = {
      ...
      level: 'project',
      filePath: '/project/.claudex/agents/monitor.md',
      background: true,
    };
