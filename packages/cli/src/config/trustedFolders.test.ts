...
import { FatalConfigError, ideContextStore } from '@claudex/core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use CLAUDEX_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['CLAUDEX_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['CLAUDEX_TRUSTED_FOLDERS_PATH'];
  });
