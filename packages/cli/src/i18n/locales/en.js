...
// English translations for Claudex Code CLI
...
export default {
  ...
  'for help on Claudex Code': 'for help on Claudex Code',
  'show version info': 'show version info',
  'submit a bug report': 'submit a bug report',
  'About Claudex Code': 'About Claudex Code',
  Status: 'Status',
  ...
  'Available Claudex Code CLI tools:': 'Available Claudex Code CLI tools:',
  ...
  // ============================================================================
  'Project Level (.claudex/agents/)': 'Project Level (.claudex/agents/)',
  'User Level (~/.claudex/agents/)': 'User Level (~/.claudex/agents/)',
  ...
  // ============================================================================
  'View and edit Claudex Code settings': 'View and edit Claudex Code settings',
  Settings: 'Settings',
  ...
  'Respect .claudexignore': 'Respect .claudexignore',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Claudex Code hooks': 'Manage Claudex Code hooks',
  ...
  'block processing, erase original prompt, and show stderr to user only':
    'block processing, erase original prompt, and show stderr to user only',
  'stdout shown to Claudex': 'stdout shown to Claudex',
  ...
  'Add MCP servers to your settings to get started.':
    'Add MCP servers to your settings to get started.',
  'Run claudex --debug to see error logs': 'Run claudex --debug to see error logs',
  ...
  'Claudex OAuth authentication cancelled.':
    'Claudex OAuth authentication cancelled.',
  'Claudex OAuth Authentication': 'Claudex OAuth Authentication',
  ...
  'Claudex OAuth Authentication Timeout': 'Claudex OAuth Authentication Timeout',
  ...
  'Saved in .claudex/settings.local.json': 'Saved in .claudex/settings.local.json',
  'Project settings': 'Project settings',
  'Checked in at .claudex/settings.json': 'Checked in at .claudex/settings.json',
  'User settings': 'User settings',
  'Saved in at ~/.claudex/settings.json': 'Saved in at ~/.claudex/settings.json',
  ...
  'Configure Claudex authentication information with Claudex-OAuth or Alibaba Cloud Coding Plan':
    'Configure Claudex authentication information with Claudex-OAuth or Alibaba Cloud Coding Plan',
  'Authenticate using Claudex OAuth': 'Authenticate using Claudex OAuth',
  ...
  '  claudex auth                - Interactive authentication setup\n':
    '  claudex auth                - Interactive authentication setup\n',
  '✓ Authentication Method: Claudex OAuth': '✓ Authentication Method: Claudex OAuth',
