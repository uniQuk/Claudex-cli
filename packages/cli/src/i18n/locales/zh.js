...
// Chinese translations for Claudex Code CLI
...
export default {
  ...
  'for help on Claudex Code': '获取 Claudex Code 帮助',
  'show version info': '显示版本信息',
  'submit a bug report': '提交错误报告',
  'About Claudex Code': '关于 Claudex Code',
  Status: '状态',
  ...
  'Analyzes the project and creates a tailored CLAUDEX.md file.':
    '分析项目并创建定制的 CLAUDEX.md 文件',
  'List available Claudex Code tools. Usage: /tools [desc]':
    '列出可用的 Claudex Code 工具。用法：/tools [desc]',
  'List available skills.': '列出可用技能。',
  'Available Claudex Code CLI tools:': '可用的 Claudex Code CLI 工具：',
  ...
  // ============================================================================
  'Project Level (.claudex/agents/)': '项目级 (.claudex/agents/)',
  'User Level (~/.claudex/agents/)': '用户级 (~/.claudex/agents/)',
  ...
  'Generate with Claudex Code (Recommended)': '使用 Claudex Code 生成（推荐）',
  ...
  // ============================================================================
  'View and edit Claudex Code settings': '查看和编辑 Claudex Code 设置',
  Settings: '设置',
  'To see changes, Claudex Code must be restarted. Press r to exit and apply changes now.':
    '要查看更改，必须重启 Claudex Code。按 r 退出并立即应用更改。',
  ...
  'How is Claudex doing this session? (optional)': 'Claudex 这次表现如何？（可选）',
  Bad: '不满意',
  Fine: '还行',
  Good: '满意',
  Dismiss: '忽略',
  ...
  'Respect .claudexignore': '遵守 .claudexignore',
  ...
  'This extension will append info to your CLAUDEX.md context using {{fileName}}':
    '此扩展将使用 {{fileName}} 向您的 CLAUDEX.md 上下文追加信息',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with Claudex Code.':
    '您正在安装来自 {{originSource}} 的扩展。某些功能可能无法完美兼容 Claudex Code。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run Claudex Code in one of these supported IDEs: VS Code or VS Code forks.':
    '您当前环境不支持 IDE 集成。要使用此功能，请在以下支持的 IDE 之一中运行 Claudex Code：VS Code 或 VS Code 分支版本。',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage Claudex Code hooks': '管理 Claudex Code Hook',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask Claudex Code.':
    '此菜单为只读。要添加或修改 Hook，请直接编辑 settings.json 或询问 Claudex Code。',
  ...
  'To add hooks, edit settings.json directly or ask Claudex.':
    '要添加 Hook，请直接编辑 settings.json 或询问 Claudex。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask Claudex to help.':
    '要修改或删除此 Hook，请直接编辑 settings.json 或询问 Claudex。',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask Claudex Code.':
    '要重新启用 Hook，请从 settings.json 中删除 "disableAllHooks" 或询问 Claudex Code。',
  // Hooks - Source
  Project: '项目',
  User: '用户',
  System: '系统',
  ...
  'Right before Claudex Code concludes its response': 'Claudex Code 结束响应之前',
  ...
  'stdout shown to Claudex': '向 Claudex 显示 stdout',
  ...
  'Run claudex --debug to see error logs': '运行 claudex --debug 查看错误日志',
  ...
  'Generate a project summary and save it to .claudex/PROJECT_SUMMARY.md':
    '生成项目摘要并保存到 .claudex/PROJECT_SUMMARY.md',
  ...
  'Claudex OAuth': 'Claudex OAuth (免费)',
  ...
  'Claudex OAuth authentication timed out. Please try again.':
    'Claudex OAuth 认证超时。请重试',
  'Claudex OAuth authentication cancelled.': 'Claudex OAuth 认证已取消',
  'Claudex OAuth Authentication': 'Claudex OAuth 认证',
  ...
  'Claudex OAuth Authentication Timeout': 'Claudex OAuth 认证超时',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuth 令牌已过期（超过 {{seconds}} 秒）。请重新选择认证方法',
  'Press any key to return to authentication type selection.':
    '按任意键返回认证类型选择',
  'Waiting for Claudex OAuth authentication...': '正在等待 Claudex OAuth 认证...',
  'Note: Your existing API key in settings.json will not be cleared when using Claudex OAuth. You can switch back to OpenAI authentication later if needed.':
    '注意：使用 Claudex OAuth 时，settings.json 中现有的 API 密钥不会被清除。如果需要，您可以稍后切换回 OpenAI 认证。',
  'Note: Your existing API key will not be cleared when using Claudex OAuth.':
    '注意：使用 Claudex OAuth 时，现有的 API 密钥不会被清除。',
  ...
  'Invalid CLAUDEX_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '无效的 CLAUDEX_DEFAULT_AUTH_TYPE 值："{{value}}"。有效值为：{{validValues}}',
  ...
  'Claudex 3.6 Plus — efficient hybrid model with leading coding performance':
    'Claudex 3.6 Plus — 高效混合架构，编程性能业界领先',
  'The latest Claudex Vision model from Alibaba Cloud ModelStudio (version: claudex3-vl-plus-2025-09-23)':
    '来自阿里云 ModelStudio 的最新 Claudex Vision 模型（版本：claudex3-vl-plus-2025-09-23）',
  ...
  'Saved in .claudex/settings.local.json': '保存在 .claudex/settings.local.json',
  'Project settings': '项目设置',
  'Checked in at .claudex/settings.json': '保存在 .claudex/settings.json',
  'User settings': '用户设置',
  'Saved in at ~/.claudex/settings.json': '保存在 ~/.claudex/settings.json',
  ...
  'You can run any shell commands from Claudex Code using ! (e.g. !ls).':
    '在 Claudex Code 中使用 ! 可运行任意 shell 命令（例如 !ls）。',
  ...
  'You can resume a previous conversation by running claudex --continue or claudex --resume.':
    '运行 claudex --continue 或 claudex --resume 可继续之前的会话。',
  ...
  'Add a CLAUDEX.md file to give Claudex Code persistent project context.':
    '添加 CLAUDEX.md 文件，为 Claudex Code 提供持久的项目上下文。',
  ...
  // Exit Screen / Stats
  // ============================================================================
  'Agent powering down. Goodbye!': 'Claudex Code 正在关闭，再见！',
  ...
  'Configure Claudex authentication information with Claudex-OAuth or Alibaba Cloud Coding Plan':
    '使用 Claudex OAuth 或阿里云百炼 Coding Plan 配置 Claudex 认证信息',
  'Authenticate using Claudex OAuth': '使用 Claudex OAuth 进行认证',
  ...
  'Starting Claudex OAuth authentication...': '正在启动 Claudex OAuth 认证...',
  'Successfully authenticated with Claudex OAuth.': '已成功通过 Claudex OAuth 认证。',
  'Failed to authenticate with Claudex OAuth: {{error}}':
    'Claudex OAuth 认证失败：{{error}}',
  ...
  '  claudex auth claudex-oauth     - Authenticate with Claudex OAuth (discontinued)':
    '  claudex auth claudex-oauth     - 使用 Claudex OAuth 登录（已停用）',
  '  claudex auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  claudex auth coding-plan      - 使用阿里云百炼 Coding Plan 认证\n',
  'Or simply run:': '或者直接运行：',
  '  claudex auth                - Interactive authentication setup\n':
    '  claudex auth                - 交互式认证配置\n',
  '✓ Authentication Method: Claudex OAuth': '✓ 认证方式：Claudex OAuth',
  ...
  'Claudex OAuth free tier was discontinued on 2026-04-15. Run /auth to switch to Coding Plan, OpenRouter, Fireworks AI, or another provider.':
    'Claudex OAuth 免费额度已于 2026-04-15 停用。请运行 /auth 切换到 Coding Plan、OpenRouter、Fireworks AI 或其他服务商。',
  ...
  '  Run `claudex auth coding-plan` to re-configure.\n':
    '  运行 `claudex auth coding-plan` 重新配置。\n',
  ...
  "Set up Claudex Code's status line UI": '配置 Claudex Code 的状态栏',
};
