...
import { read as readJsonlFile } from '@claudex/core';
      ...
      const facets: SessionFacets[] = [
        {
          ...
          Claudex_helpfulness: 'very_helpful',
        ...
        },
        {
          ...
          Claudex_helpfulness: 'moderately_helpful',
    ...
    it('should aggregate primary success excluding none', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          user_satisfaction_counts: {},
          Claudex_helpfulness: 'slightly_helpful',
