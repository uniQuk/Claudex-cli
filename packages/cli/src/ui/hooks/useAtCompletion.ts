...
import type { Config, FileSearch } from '@claudex/core';
import { FileSearchFactory, escapePath } from '@claudex/core';
    ...
    const initialize = async () => {
      try {
        const searcher = FileSearchFactory.create({
          ...
          useQwenignore:
            config?.getFileFilteringOptions()?.respectClaudexIgnore ?? true,
          cache: true,
