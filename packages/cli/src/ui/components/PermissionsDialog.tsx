...
import { isPathWithinRoot, parseRule } from '@claudex/core';
  ...
  return [
    {
      id: 'allow',
      label: t('Allow'),
      description: t("Claudex won't ask before using allowed tools."),
    },
    {
      id: 'ask',
      label: t('Ask'),
      description: t('Claudex will ask before using these tools.'),
    },
    {
      id: 'deny',
      label: t('Deny'),
      description: t('Claudex is not allowed to use denied tools.'),
    },
    {
      id: 'workspace',
      label: t('Workspace'),
    ...
    return (
      <Box flexDirection="column">
        ...
        <Text color={theme.text.secondary} wrap="wrap">
          {t(
            'Claudex will be able to read files in this directory and make edits when auto-accept edits is on.',
          )}
        </Text>
        <Box height={1} />
  ...
  if (activeTab.id === 'workspace') {
    ...
    return (
      <Box flexDirection="column">
        ...
        <Text color={theme.text.secondary} wrap="wrap">
          {t(
            'Claudex can read files in the workspace, and make edits when auto-accept edits is on.',
          )}
        </Text>
        <Box height={1} />
