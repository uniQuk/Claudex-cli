...
export const AppContainer = (props: AppContainerProps) => {
  ...
  // Update terminal title with Claudex status and thoughts
  useEffect(() => {
    ...
    // Note: We don't need to reset the window title on exit because Claudex is already doing that elsewhere
  }, [
    streamingState,
    thought,
    settings.merged.ui?.showStatusInTitle,
